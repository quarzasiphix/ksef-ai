-- Migration: Update auto_post functions to ensure periods exist before posting
-- Purpose: Prevent posting invoices to non-existent periods

-- ============================================================================
-- 1. Update auto_post_invoice to ensure period exists
-- ============================================================================
...
COMMENT ON FUNCTION auto_post_invoice IS 'Auto-posts an invoice to the ledger. Ensures accounting period exists before posting. Returns success status and journal entry details.';
