...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const [
      ...
      // 5. Get cash register summary - placeholder (summary computed below)
    ...
    const response = {
      ...
      cashSummary: cashSummaryResult.data,
      cashReconciliations: cashReconciliationsResult.data || [],
    };

    // Compute cash summary using fetched transactions since RPC is missing
    ...
    response.cashSummary = cashSummary;
