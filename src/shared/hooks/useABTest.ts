...
import { getSessionId } from '@/shared/lib/analytics/sessionManager';
import { assignVariant, getStoredVariant, storeVariant } from '@/shared/lib/analytics/variantAssignment';
