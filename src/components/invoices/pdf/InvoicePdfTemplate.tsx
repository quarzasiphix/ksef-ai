      ...
      <div style={{ ...pdfStyles.container, width: '100%', height: '100%', boxSizing: 'border-box' }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 14, fontWeight: 600, color: '#b91c1c', borderRadius: 8, padding: '2px 8px', display: 'inline-block' }}>{invoice.isPaid ? 'Opłacona' : 'Oczekuje'}</div>
          </div>
        </div>
        ...
        <div style={{ marginTop: '32px', paddingTop: '20px', borderTop: '2px solid #dee2e6', textAlign: 'left' }}>
          ...
          <div style={{ fontSize: '15px', color: '#495057', fontStyle: 'italic' }}>
            Słownie: {toWords(invoice.totalGrossValue || 0)}
          </div>
        </div>
